...
class HotelComparisons
  ...
  def_delegators :@hotel, :id, :star_rating, :longitude, :amenities, :latitude, :user_rating, :ranking, :booking_hotel_id, :ean_hotel_id, :splendia_hotel_id, :etb_hotel_id, :laterooms_hotel_id, :agoda_hotel_id, :laterooms_url, :booking_url

  def self.select_cols
    'id, star_rating, amenities, longitude, latitude, user_rating, ranking, laterooms_url, booking_url, ' + HotelsConfig::PROVIDER_IDS.map {|k,v| v}.join(', ')
  end
