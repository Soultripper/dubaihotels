module Booking::Seed
  class << self
    ...
    def region_hotels(offset=0, rows=1000)
      ...
      region_hotels.map  {|region_hotel| Providers::Booking::RegionHotelLookup.from_booking region_hotel}
    end
    ...
    def hotel_images(offset=0, rows=1000)
      ...
      hotel_images.map  {|hotel_image| Providers::Booking::HotelImage.from_booking hotel_image}
    end

    def hotel_facility_types
      facility_types = Booking::Client.hotel_facility_types languagecodes: 'en'
      facility_types.map {|facility_type| Providers::Booking::Amenity.from_booking facility_type}
    end
