# https://catalogs.venere.com/xhi-1.0/XHI_InventoryCatalogue?org=Venere&user=CataloguesTester&psw=T3s73R&filter={%22format%22:%22xml.zip%22}

class Venere::Admin 

  # download file and reprocess may be easier and more efficient then last changed data structure.
