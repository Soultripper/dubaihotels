    ...
    IonRangeSlider.prototype = {
        ...
        setMinMax: function () {
            ...
            if (this.options.values) {
                this.$cache.min.html(this.decorate(this.options.values[this.options.min]));
                this.$cache.max.html(this.decorate(this.options.values[this.options.max]));
            } else {
